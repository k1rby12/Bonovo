<%-- 
    Document   : nav
    Created on : 11/08/2025, 07:54:28 PM
    Author     : irvin
--%>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav w-100 justify-content-center">
        ...
        <li class="nav-item"><a class="nav-link" href="nomina.jsp">Nómina</a></li>
        <li class="nav-item"><a class="nav-link" href="puntoVenta.jsp">Punto de Venta</a></li>
      </ul>
    </div>
  </div>
</nav>
